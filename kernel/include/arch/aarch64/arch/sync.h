...
#define ldar_32(ptr, value) \
        asm volatile("ldar %w0, [%1]" : "=r"(value) : "r"(ptr))
#define stlr_32(ptr, value) \
        asm volatile("stlr %w0, [%1]" : : "rZ"(value), "r"(ptr))

#define ldar_64(ptr, value) \
        asm volatile("ldar %x0, [%1]" : "=r"(value) : "r"(ptr))
#define stlr_64(ptr, value) \
        asm volatile("stlr %x0, [%1]" : : "rZ"(value), "r"(ptr))
...
#define atomic_set_bit_32(ptr, val) \
        __atomic_fetch_op(ptr, 1 << (val), 32, w, or)
